...
在重现时，在 MNIST 使用了与论文相同的配置。 The code can be referred :githublink:`here <examples/model_compress/pruning/lottery_torch_mnist_fc.py>`. 在次实验中，修剪了10次，在每次修剪后，训练了 50 个 epoch。
